...
int main()
{
    ...
    X *xp = new X[10];
    delete[] xp;
    // delete xp; // dtor for each element will not be called, do not use delete for object arrays

    double *dp = new double[10];
    delete[] dp;
    // delete dp; // should also work with primitives, since no dtor is needed to be called
