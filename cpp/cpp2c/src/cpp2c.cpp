...
public:
    ...
    /* deep copy */
    PublicConvoy(const PublicConvoy& other_) : PublicTransport(other_)
    {
        m_pt1 = new Minibus();
        memcpy((void *)m_pt1, (void *)other_.m_pt1, sizeof(Minibus));

        m_pt2 = new Taxi();
        memcpy((void *)m_pt2, (void *)other_.m_pt2, sizeof(Taxi));

        memcpy((void *)&m_m, (void *)&other_.m_m, sizeof(Minibus));
        memcpy((void *)&m_t, (void *)&other_.m_t, sizeof(Taxi));
    }
...
int main()
{
    cout << sizeof(PublicTransport) << endl;
    cout << sizeof(Minibus) << endl;
    cout << sizeof(Taxi) << endl;
    cout << sizeof(SpecialTaxi) << endl;
